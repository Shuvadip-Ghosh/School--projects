// Take the size of an integer array from the user and input the elements in
// the array and print the sum of Prime and composite Number Separetly using a method int prime(int n)
